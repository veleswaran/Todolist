      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
        ...
        <div className="relative flex-1 sm:flex-initial sm:w-[170px]">
          ...
          <select
            ...
            className="w-full pl-11 pr-8 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-blue-500/50 outline-none text-white transition-all appearance-none cursor-pointer"
          >
        ...
        <div className="relative flex-1 sm:flex-initial sm:w-[170px]">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 focus:border-blue-500/50 outline-none text-white transition-all cursor-pointer [color-scheme:dark]"
          />
        </div>
        ...
        {(search || status !== 'all' || date || category !== 'all') && (
          <button
            onClick={onClear}
            className="py-3 px-4 rounded-xl bg-white/5 hover:bg-red-500/10 text-gray-400 hover:text-red-400 transition-all flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto"
            title="Clear Filters"
          >
            <X className="w-5 h-5" />
            <span className="sm:hidden text-sm font-semibold">Clear Filters</span>
          </button>
        )}
      </div>
    </div>
